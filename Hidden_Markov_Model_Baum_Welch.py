import numpy as np
from Hidden_Markov_Model_forward_backward import forward, backward
...
def baum_welch(observation, state_size, observation_size, epsilon=1e-8, max_iteration=500):
    ...
    where the data_size is the number of all the data initial_stateecies
    sequence_size is the length of each sequence
    """
    # initial parameters
